...
//////////////////////////////////////////////////
Shader "LEAKYFINGERS/Masked Color Post-Process"
{
	HLSLINCLUDE
		...
		float4 _MaskReplacementColor; // The color used to replace all pixels containing the mask color.
