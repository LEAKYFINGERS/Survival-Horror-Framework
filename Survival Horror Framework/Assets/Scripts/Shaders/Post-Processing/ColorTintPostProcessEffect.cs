...
namespace SurvivalHorrorFramework
{
    ...
    public sealed class ColorTintPostProcessEffectRenderer : PostProcessEffectRenderer<ColorTintPostProcessEffect>
    {
        ...
        {
            PropertySheet sheet = context.propertySheets.Get(Shader.Find("Survival Horror Framework/Color Tint Post-Process")); // The property sheet used to handle the post-process shader code.
